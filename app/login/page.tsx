...
.login-choice-brand__mark{width:34px;height:34px;border-radius:10px;background:#365a96;color:#fff;display:grid;place-items:center;font-weight:600;font-size:16px}
...
.login-choice-card:hover{border-color:#365a96;box-shadow:0 6px 24px rgba(54,90,150,.14);transform:translateY(-1px)}
...
.login-choice-card:hover .login-choice-card__arrow{background:#365a96;border-color:#365a96;color:#fff}
`;
