...
export default async function TenantPage({
  ...
  // Report (reports.php): deep-link legacy con preset/date/granularità e
  // modalità di confronto dal querystring (range, from, to, granularity,
