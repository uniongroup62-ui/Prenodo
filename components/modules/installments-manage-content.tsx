        ...
        <>
          ...
          <div className="card installments-filter-card p-3 mb-3">
            ...
            >
              ...
              <div className="col-12 col-lg-auto d-flex align-items-center align-self-end app-filter-tail gap-2 ms-lg-2 mt-2 mt-lg-0 flex-wrap installments-filter-actions">
